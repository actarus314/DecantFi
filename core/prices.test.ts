...
/** Fake fetcher that responds to any URL with the given body (ignores Horizon). */
...
describe('fetchPrices', () => {
  it('parses the DefiLlama response', async () => {
  ...
  it('tolerates a !ok response', async () => {
...
describe('targetLocalPerUnit', () => {
  ...
  it('EURC null if eurcStellarMid is absent', () =>
...
describe('priceImpactPct', () => {
  it('~1% if receiving 1% less than the spot value', () => {
    // 1000 BLND @0.0512 = 51.2 USD; net 50.688 USDC -> 1% impact
    expect(priceImpactPct(toStroops('1000'), toStroops('50.688'), 0.0512, 1)).toBeCloseTo(1, 3);
  });
  it('undefined without a price', () => {
